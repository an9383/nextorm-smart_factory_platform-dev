...
@NoArgsConstructor
@AllArgsConstructor
public class ReservoirCapacityCreateRequestDto {
	...
	public static ReservoirCapacityCreateRequestDto from(ReservoirCapacity entity) {
		if (entity == null) {
			return null;
		}
		return ReservoirCapacityCreateRequestDto.builder()
