...
@Entity
@Table(name = "health_summary_data", indexes = {
	@Index(name = "health_summary_data_search_complex_index", columnList = "parameter_id, period_type, trx_start_at desc")})
@AllArgsConstructor
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@SuperBuilder
@Getter
public class HealthSummaryData extends BaseEntity {

	@Column(columnDefinition = "Decimal(15,5)")
	@Comment("위도 소수점 4자리까지 값")
	private Double latitude;

	@Column(columnDefinition = "Decimal(15,5)")
	@Comment("경도 소수점 4자리까지 값")
