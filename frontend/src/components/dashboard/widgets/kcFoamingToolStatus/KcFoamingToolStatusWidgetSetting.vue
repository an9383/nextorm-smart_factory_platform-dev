      ...
      <div class="row q-col-gutter-lg">
        ...
        <div class="col-12 col-md-6">
          <div class="equipment-field">
            ...
            <cascader
              :model-value="parameterIdToTreeIdMap.get(config.materialSettingParameterId)"
              @update:model-value="(treeId) => onEquipmentParamChanged('materialSettingParameterId', treeId)"
              :titles="[$t('설비'), $t('파라미터')]"
              :items="parameterToolTree"
              item-value="treeId"
              item-text="name"
        ...
        <div class="col-12 col-md-6">
          <div class="equipment-field">
            ...
            <cascader
              :model-value="parameterIdToTreeIdMap.get(config.materialCurrentParameterId)"
              @update:model-value="(treeId) => onEquipmentParamChanged('materialCurrentParameterId', treeId)"
              :titles="[$t('설비'), $t('파라미터')]"
              :items="parameterToolTree"
              item-value="treeId"
              item-text="name"
...
const config = useWidgetSettingConfig({
  ...
  materialSettingParameterId: null, // 원료세팅값
  materialCurrentParameterId: null, // 원료경과값
  cycleTime: null, //사이클 타임
