  ...
  <div class="stiffener-card">
    ...
    <div class="parameters-grid">
      ...
      <div class="parameter-item">
        <div class="parameter-label">생산량</div>
        <div class="parameter-value">{{ productionCount }}</div>
      </div>

      <div class="parameter-item">
        <div class="parameter-label">원료세팅값</div>
        <div class="parameter-value">{{ materialSettingValue }}</div>
      </div>

      <div class="parameter-item">
        <div class="parameter-label">원료경과값</div>
        <div class="parameter-value">{{ materialCurrentValue }}</div>
      </div>
      ...
      <div class="parameter-item large">
